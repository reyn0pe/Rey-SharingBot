...
class Bot(Client):
    ...
    async def start(self):
        try:
            ...
            self.LOGGER(__name__).info(
                "Bot Berhenti. Silahkan Tanyakan Ke Bos https://t.me/xyreynld untuk Bantuan"
            )
            sys.exit()
        ...
        if FORCE_SUB_GROUP:
            try:
                ...
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Silahkan Tanyakan Ke Bis https://t.me/xyreynld untuk Bantuan"
                )
                sys.exit()
        ...
        try:
            ...
            self.LOGGER(__name__).info(
                "Bot Berhenti. Gabung Group https://t.me/KyuraSupportGroup untuk Bantuan"
            )
            sys.exit()

        self.set_parse_mode("html")
        self.LOGGER(__name__).info(
            f"[🔥 UDAH AKTIF YA KONTOL! 🔥]\n\nBOT Dibuat oleh @{OWNER}\nJika @{OWNER} Membutuhkan Bantuan, Silahkan Tanyakan Ke https://t.me/xyreynld Jangan Lupa Join https://t.me/ReyUpdatesCH Untuk Support Rey Thanks ☺️"
        )
