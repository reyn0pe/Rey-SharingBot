...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("<code>Bentar Ya Kontol...</code>", quote=True)
    try:
        ...
        await reply_text.edit_text("<b>Mampus Error Makanya Join https://t.me/ReyUpdatesCH</b>")
        return
    ...
    await reply_text.edit(
        f"<b>Link Asupan Udah Beres Gue Buat Ya Memek</b>\n\n{link}",
